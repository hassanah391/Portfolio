...
import { CheckCircle2, Github, Images, Linkedin, PlayCircle } from "lucide-react";
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {project.video ? (
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-violet-500 px-3 py-2 text-xs font-semibold text-black transition-colors hover:bg-violet-400"
          >
            <PlayCircle size={15} />
            Watch Demo
          </a>
        ...
        {project.linkedIn ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3 py-2 text-xs font-semibold transition-colors hover:border-blue-400/60 hover:text-blue-300"
          >
            <Linkedin size={15} />
            LinkedIn Post
          </a>
        ...
        {project.github ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3 py-2 text-xs font-semibold transition-colors hover:border-violet-400/60 hover:text-violet-300"
          >
            <Github size={15} />
            GitHub Repo
          </a>
